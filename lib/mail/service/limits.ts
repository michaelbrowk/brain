export const MAIL_SERVICE_HTTP_LIMITS = Object.freeze({
  ...
  // A 26 MiB message is roughly 35 MiB of base64 inside a JSON body, and
  // readJsonBody refuses any maxBodyBytes above maxDraftBodyBytes, so the two
  // move together or every attachment send answers 413.
  maxSendBodyBytes: 40 * 1024 * 1024,
  ...
  maxDraftBodyBytes: 40 * 1024 * 1024,
